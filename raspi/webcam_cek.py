...
def process_frame(frame):
    ...
    if len(contours) > 0:
        ...
        cv2.putText(frame, text, text_position, cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(frame, text2, text_position2, cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
